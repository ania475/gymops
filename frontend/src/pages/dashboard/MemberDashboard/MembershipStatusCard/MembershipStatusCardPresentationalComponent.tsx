...
export function MembershipStatusCardPresentational({ membership }: Props) {
  return (
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <h2 className="font-display text-2xl font-bold">{membership.plan}</h2>
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          ...
          <Button className="bg-highlight hover:bg-highlight/90 text-highlight-foreground" asChild>
